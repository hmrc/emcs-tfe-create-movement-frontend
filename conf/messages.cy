...
consignorAddress.title = Enter the consignor’s address
consignorAddress.heading = Enter the consignor’s address
consignorAddress.subheading = Consignor information
consignorAddress.property = Property name or number (optional)
consignorAddress.property.error.length = Enter a property name or number up to 11 characters
consignorAddress.street = Street name
consignorAddress.street.error.required = Enter a street name
consignorAddress.street.error.length = Enter a street name up to 65 characters
consignorAddress.town = Town or city
consignorAddress.town.error.required = Enter a town or city
consignorAddress.town.error.length = Enter a town or city name up to 50 characters
...
giveInformationOtherTransport.checkYourAnswersLabel = Information about other transport
