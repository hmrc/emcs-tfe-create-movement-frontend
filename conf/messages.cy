...
transportSealChoice.title = Is there a commercial seal on this {0}?
transportSealChoice.heading = Is there a commercial seal on this {0}?
transportSealChoice.checkYourAnswersLabel = transportSealChoice
transportSealChoice.error.required = Select yes if there is a commercial seal on this {0}?
transportSealChoice.change.hidden = TransportSealChoice
transportSealChoice.hint = This is a seal that prevents items being removed or added. For example, a seal on the outermost packaging, or a seal on the transport.
