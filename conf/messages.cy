...
localReferenceNumber.change.hidden = Local Reference Number (LRN)
...
journeyTimeHours.error.wholeNumber = Enter how many hours the journey will take using whole numbers
journeyTimeHours.error.outOfRange = Hours must be 23 or less
...
consigneeExportVat.checkYourAnswers.label.yesEoriNumber = EORI Number
consigneeExportVat.checkYourAnswers.label.yesVatNumber = VAT Number
...
transportArrangerVat.4.heading = What is the transport arranger’s UK VAT registration number?
transportArrangerVat.hint = This is 9 or 12 numbers, sometimes with ‘GB’ at the start, like 123456789 or GB123456789.
transportArrangerVat.3.notUkVatLink = The goods owner is not UK VAT registered
transportArrangerVat.4.notUkVatLink = The transport arranger is not UK VAT registered
transportArrangerVat.error.required = Enter a VAT registration number
...
firstTransporterVat.hint = This is 9 or 12 numbers, sometimes with ‘GB’ at the start, like 123456789 or GB123456789.
firstTransporterVat.notUkVatLink = The first transporter is not VAT registered
...
consigneeExcise.checkYourAnswersLabel = Excise registration number (ERN)
...
dispatchWarehouseExcise.error.length = Excise ID must be 16 characters or less
dispatchWarehouseExcise.error.xss = Excise ID contain < and > and : and ;
...
guarantorVat.4.title = What is the transporter’s VAT registration number?
guarantorVat.4.heading = What is the transporter’s VAT registration number?
...
transportUnitGiveMoreInformation.title = Give more information about this {0}
transportUnitGiveMoreInformation.heading = Give more information about this {0}
...
destinationWarehouseExcise.title = What is the excise registration number (ERN) for the destination tax warehouse?
destinationWarehouseExcise.heading = What is the excise registration number (ERN) for the destination tax warehouse?
destinationWarehouseExcise.text = This number contains 13 alpha-numeric characters starting with GB and can be found on your approval letter.
destinationWarehouseExcise.checkYourAnswersLabel = destinationWarehouseExcise
destinationWarehouseExcise.error.required = Enter the excise registration number (ERN)
...
dispatchDetails.dateOfDispatch.checkYourAnswersLabel = Date of dispatch
dispatchDetails.dateOfDispatch.change.hidden = date of dispatch
dispatchDetails.timeOfDispatch.checkYourAnswersLabel = Time of dispatch
dispatchDetails.timeOfDispatch.change.hidden = time of dispatch
