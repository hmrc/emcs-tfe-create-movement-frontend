...
invoiceDetails.invoice-date.label = Invoice date of issue
invoiceDetails.invoice-date.hint = For example, 6 10 2023.
invoiceDetails.invoice-date.error.required.all = Enter the date of issue, or skip this question for now
invoiceDetails.invoice-date.error.required.two = Date of issue must include a {0} and {1}
invoiceDetails.invoice-date.error.required = Date of issue must include a {0}
invoiceDetails.invoice-date.error.invalid = Date of issue must be a real date
