...
trait BaseFixtures {
  ...
  val templateId: String = "templateId1"
  val templateName: String = "MyTemplate"
  ...
  val testUserAddress = UserAddress(Some(testBusinessName), Some("10"), Some("Test Street"), Some("Testown"), Some("ZZ1 1ZZ"))
