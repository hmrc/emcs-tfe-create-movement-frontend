...
object ConfirmationMessages {
  ...
  sealed trait ViewMessages extends BaseMessages { _: i18n =>
    ...
    val p2 = "If unsuccessful, you’ll get an error which you must correct and resubmit until you get an ARC. Contact the HMRC excise helpline if you need more help or information about excise duties."
    ...
    val feedbackLink = "What did you think of this service? (takes 30 seconds)"
