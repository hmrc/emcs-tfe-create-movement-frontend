...
class ItemPackagingRemovePackageFormProviderSpec extends SpecBase with BooleanFieldBehaviours {

  val requiredKey = "itemPackagingRemovePackage.error.required"
  val invalidKey = "error.boolean"

  val form = new ItemPackagingRemovePackageFormProvider()()
