...
trait MockGetItemPackagingTypesConnector extends MockFactory {
  ...
  object MockGetItemPackagingTypesConnector {
    ...
    def getItemPackagingTypes(): CallHandler3[Option[Boolean], HeaderCarrier, ExecutionContext, Future[Either[ErrorResponse, Seq[ItemPackaging]]]] =
      (mockGetItemPackagingTypesConnector.getItemPackagingTypes(_: Option[Boolean])(_: HeaderCarrier, _: ExecutionContext)).expects(*, *, *)
  }
