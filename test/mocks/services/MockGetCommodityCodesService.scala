...
import services.GetCommodityCodesService
import uk.gov.hmrc.http.HeaderCarrier

import scala.concurrent.Future

trait MockGetCommodityCodesService extends MockFactory {

  lazy val mockGetCommodityCodesService: GetCommodityCodesService = mock[GetCommodityCodesService]
