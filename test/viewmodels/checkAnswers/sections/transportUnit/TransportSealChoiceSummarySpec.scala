      ...
      s"when being rendered in lang code of '${messagesForLanguage.lang.code}'" - {
        ...
        "when there's no answer" - {
          ...
          "must output no row" in {
            ...
            TransportSealChoiceSummary.row(testIndex1, request.userAnswers) mustBe None
          }
        }
        ...
        "when there's an answer" - {
          ...
          s"must output the expected row for TransportSealChoice" in {
            ...
            TransportSealChoiceSummary.row(testIndex1, request.userAnswers) mustBe
              Some(
                SummaryListRowViewModel(
                  ...
                  actions = Seq(
                    ActionItemViewModel(
                      ...
                      href = controllers.sections.transportUnit.routes.TransportSealChoiceController.onPageLoad(testErn, testLrn, testIndex1, CheckMode).url,
