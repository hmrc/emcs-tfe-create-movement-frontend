          ...
          "must return the correct content" in {
            ...
            result mustBe HtmlContent(HtmlFormat.fill(Seq(
              ...
              list(Seq(
                ...
                p()(Html("The place trader postcode must not start with ‘BT’ where the place of dispatch if from an excise warehouse in Great Britain.")),
                p()(Html("The place trader postcode must start with ‘BT’ where the place of dispatch if from an excise warehouse in Northern Ireland.")),
                ...
                p()(Html("The Third County of Origin Code must be provided for imported wine.")),
                ...
                p()(Html("The Third County of Origin Code in not required for non-imported wine.")),
