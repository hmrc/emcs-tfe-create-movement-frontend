...
import fixtures.messages.CheckYourAnswersConsignorMessages
...
class CheckYourAnswersConsignorViewSpec extends ViewSpecBase with ViewBehaviours {
  ...
  "CheckYourAnswersConsignor view" - {
    ...
    Seq(CheckYourAnswersConsignorMessages.English, CheckYourAnswersConsignorMessages.Welsh).foreach { messagesForLanguage =>
      ...
      s"when being rendered in lang code of '${messagesForLanguage.lang.code}'" - {
        ...
        implicit val doc: Document = Jsoup.parse(view(
          controllers.routes.CheckYourAnswersConsignorController.onSubmit(testErn, testLrn),
          testErn,
          testLrn,
          testUserAddress,
        ...
        "have a link to change details" in {
          ...
          doc.select(Selectors.govukSummaryListChangeLink).attr("href") mustBe
            controllers.routes.ConsignorAddressController.onPageLoad(testErn, testLrn, CheckMode).url
        }
      }
    }
  }
