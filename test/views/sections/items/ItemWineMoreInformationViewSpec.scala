...
class ItemWineMoreInformationViewSpec extends SpecBase with ViewBehaviours {

  object Selectors extends BaseSelectors

  "ItemWineMoreInformation view" - {
    ...
    Seq(ItemWineMoreInformationMessages.English).foreach { messagesForLanguage =>
      ...
      s"when being rendered in lang code of '${messagesForLanguage.lang.code}'" - {
       ...
       lazy val view = app.injector.instanceOf[ItemWineMoreInformationView]
        val form = app.injector.instanceOf[ItemWineMoreInformationFormProvider].apply()
